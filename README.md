...
Case dokümanında Expo SQLite bonus olarak belirtilmiştir. Bu projede ise Zustand Persist + AsyncStorage tercih edilmiştir.

Bu uygulamanın veri modeli oldukça basittir. Her video için yalnızca başlık, açıklama, video yolu ve oluşturulma tarihi gibi sınırlı bilgiler saklanmaktadır. Bu nedenle ilişkisel veritabanı yapısına veya karmaşık SQL sorgularına ihtiyaç duyulmamaktadır.
